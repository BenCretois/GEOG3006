...
<span style="color: blue;">**Question 4**</span>: Recreate the following plot, and describe in context of the data what it shows.

```{r, echo=FALSE}
knitr::include_graphics("C:/Users/benjamcr/Rproj/GEOG3006/ex/imgs/plot_ex3.png")
```
