...
# Introduction to data vizualisation - Part 2
...
```{r, echo = TRUE}
kids2 <- dplyr::filter(kids_frame, sex == 'm') # I write dplyr::filter to tell R that I want to use the filter function from the package dplyr. Other filter function exist and we need to avoid any misunderstanding.
head(kids2)
```
